...
const Heropage = () => {
  return (
    <div className="flex flex-col md:flex-row h-[80%] md:h-screen">
      <div className="w-full md:w-1/2 flex flex-col justify-center items-start p-8 md:ml-[100px] md:mr-[40px]"> {/* Reduced left margin */}
        <h1 className="font-[Libre Bodoni] text-[37.84px] md:text-[40px] font-bold mt-[80px] md:mt-[150px] leading-tight">
          IMPECCABLE<br /> CRAFTSMANSHIP AND <br />FINESSE
        </h1>
        <p className="w-full md:w-[902px] text-[29.24px] md:text-[30px] pt-[10px] md:pt-[15px] text-[#787054]">
